...
const STEPS = [
  ...
  },
  {
    ...
    title: '생산 라인 진행률',
    body: '현재 로트의 진행률과, 각 제품이 개포장→이송→충전→검사 파이프라인을 통과하는 현황입니다. 로트가 표준시간을 채우면 자동으로 완료되고 다음 로트가 올라옵니다.',
  },
  {
    target: '[data-tour="queue"]',
    title: '생산 오더 대기열',
    body: '작업지시는 로트(품목+수량) 단위입니다. 로트 추가·엑셀 업로드·취소를 여기서 하고, 행을 드래그하면 생산 순서를 바꿀 수 있습니다(운영자 이상). 맨 위 로트가 지금 라인을 흐르고 있습니다.',
  },
  {
