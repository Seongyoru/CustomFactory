...
const STEPS = [
  ...
  },
  {
    ...
    title: '생산 라인 진행률',
    body: '맨 위 작업의 진행률과 단계별 부하, 금일 누적 생산량입니다. 작업이 표준시간을 채우면 자동으로 완료되고 다음 작업이 올라옵니다.',
  },
  {
    target: '[data-tour="queue"]',
    title: '작업 대기열',
    body: '작업 추가·엑셀 업로드·취소를 여기서 합니다. 행을 드래그하면 순서를 바꿀 수 있습니다(운영자 이상). 맨 위 작업이 지금 생산 중인 작업입니다.',
  },
  {
